  ...
  return (
    <main className="min-h-screen bg-white text-zinc-950">
      ...
      <section className="relative min-h-[calc(100vh-88px)] ">
        ...
        {/* GÜVEN PANELİ */}
        <div className="bg-white px-7 py-10 md:px-14 lg:px-20">
          <div className="mx-auto grid max-w-[1300px] overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm md:grid-cols-2 xl:grid-cols-4">
            {/* GÜVENİLİR DANIŞMANLIK */}
            <div className="flex items-center gap-4 border-b border-slate-200 p-5 md:border-r xl:border-b-0">
              ...
              <div className="grid items-stretch lg:grid-cols-2">
                ...
                <div className="flex flex-col justify-center px-7 py-12 md:px-12 lg:px-14 lg:py-16">
                  ...
                  <p className="mt-6 max-w-xl text-base leading-8 text-zinc-600 md:text-lg">
                    Bütçenizi, beklentilerinizi ve yatırım hedeflerinizi
                    paylaşın. Size uygun gayrimenkulleri birlikte
                    değerlendirelim.
                  </p>
              ...
              <div className="p-6">
                ...
                {latestYouTubeVideo?.url && (
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="mt-6 inline-flex items-center gap-2 font-semibold transition hover:text-blue-600"
                  >
                    YouTube&apos;da İzle
                    <span>→</span>
                  </a>
